...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        ...
        cell.textLabel.text = @"My awesome Cell.";
...
// Get detection of a cell

-(void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    
    NSLog(@"Row Selected");
    UIAlertController *myAlert = [UIAlertController alertControllerWithTitle:@"Word" message:@"Cell Selected" preferredStyle:UIAlertControllerStyleAlert];
